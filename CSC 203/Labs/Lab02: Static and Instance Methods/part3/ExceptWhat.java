...
public class ExceptWhat
{
   ...
   private static void intermediate2(boolean isBad) throws EOFException, FileNotFoundException {
       ...
       */
      try{ intermediate3(isBad); }
      catch (EOFException e) { System.out.println("intermediate 2 - eof handled"); }
   }

   private static void intermediate1() throws EOFException, FileNotFoundException {
       ...
       * other exceptions.
       */
      try { intermediate2(true); }
      catch (FileNotFoundException e) { System.out.println("intermediate 1 - handling missing file"); }
   }
   ...
   public static void main(String[] args) {
      ...
      try{
         ...
         System.out.println("main handling EOFException");
      } catch (FileNotFoundException f) {
         System.out.println("main handling FileNotFoundException");
      }
