...
public class TestCases
{
   ...
   public void testExercise4()
   {
      ...
      final List<Integer> result = mapIt(numbers, x -> x + n); //adding 10 to every index in the list
   ...
   public void testExercise5()
   {
      ...
      final List<String> result = mapIt(strings, String::toLowerCase); //change each to lower case
