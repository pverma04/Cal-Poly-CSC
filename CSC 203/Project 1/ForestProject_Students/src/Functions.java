...
public final class Functions
{
            ...
            Action action, EventScheduler scheduler)
    {
        ...
        if (action.getRepeatCount() != 1) {
            scheduler.scheduleEvent(action.getEntity(),
                    action.getEntity().createAnimationAction(Math.max(action.getRepeatCount() - 1, 0)),
    ...
    */
            ...
            EventScheduler scheduler)
    {
        ...
        if (fairyTarget.isPresent()) {
            ...
            if (world.moveToFairy(entity, fairyTarget.get(), scheduler)) {
    ...
    */
                                          ...
                                          ImageStore imageStore)
    {
        ...
        {
            return world.transformSapling(entity, scheduler, imageStore);
        }
        else
        {
            throw new UnsupportedOperationException(
    ...
    */
            ...
            EventScheduler scheduler)
    {
        if (adjacent(dude.getPos(), target.getPos())) {
            ...
            Point nextPos = dude.nextPositionDude(world, target.getPos());
